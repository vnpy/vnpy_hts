                ...
                for struct_field, struct_type in struct_fields.items():
                    if struct_type == "string":
                        ...
                        if struct_field == "requestID" or struct_field == "localOrderID"or struct_field == "sessionID":
                            line = f"\tgetInt(req, \"{struct_field}\", &myreq.{struct_field});\n"
                        else:
...
if __name__ == "__main__":
    md_generator = ApiGenerator("../include/hts/DFITCSECMdApi.h", "HTS", "md", "MdApi")
    md_generator.run()

    td_generator = ApiGenerator("../include/hts/DFITCSECTraderApi.h", "HTS", "td", "TdApi")
    td_generator.run()

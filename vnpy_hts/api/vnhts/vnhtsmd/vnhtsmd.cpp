...
void MdApi::createDFITCMdApi(string pszLogDir)
{
	this->api = DFITCSECMdApi::CreateDFITCMdApi(pszLogDir.c_str());
};
...
int MdApi::init(string pszSvrAddr)
{
	this->active = true;
	this->task_thread = thread(&MdApi::processTask, this);
	int i = this->api->Init(pszSvrAddr.c_str(), this);
	return i;
};
